...
export default function BasariHikayesiDuzenlePage() {
  ...
  useEffect(() => {
    async function fetchData() {
      ...
      // 1. Sadece başarı hikayesi kategorilerini çek
      ...
      // 2. Mevcut başarı hikayesini çek
  ...
  if (isLoading) {
    return <div className="p-8 text-gray-500 font-medium">Hikaye bilgileri yükleniyor...</div>;
  }
  ...
  return (
    <div className="max-w-5xl space-y-6 pb-20">
      <div className="flex items-center gap-4">
        ...
        <h1 className="text-3xl font-bold text-gray-800">Hikayeyi Düzenle</h1>
      </div>
      ...
      <form onSubmit={handleSave} className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        <div className="lg:col-span-2 space-y-6">
          <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-100 space-y-4">
            ...
            <div>
                <label className="block text-sm font-medium text-gray-700 mb-1">Hikaye İçeriği</label>
