...
/>
        ...
        <div className="space-y-6">
           ...
           <button type="submit" disabled={isSaving} className="w-full flex items-center justify-center gap-2 bg-green-600 hover:bg-green-700 text-white py-3 rounded-xl font-bold shadow-lg transition-all disabled:opacity-50">
             <Save className="w-5 h-5" />
             {isSaving ? "Kaydediliyor..." : "Projeyi Yayınla"}
           </button>
        </div>
      </form>
    </div>
